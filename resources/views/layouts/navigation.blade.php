<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('craft.unit')" :active="request()->routeIs('craft.*')">
                        {{ __('Crafting') }}
                    </x-nav-link>
                    <x-nav-link :href="route('teams.index')" :active="request()->routeIs('teams.*')">
                        {{ __('Teams') }}
                    </x-nav-link>
                    <x-nav-link :href="route('matches.create')" :active="request()->routeIs('matches.*')">
                        {{ __('Battles') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('craft.unit')" :active="request()->routeIs('craft.*')">
                {{ __('Crafting') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('teams.index')" :active="request()->routeIs('teams.*')">
                {{ __('Teams') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('matches.create')" :active="request()->routeIs('matches.*')">
                {{ __('Battles') }}
            </x-responsive-nav-link>
